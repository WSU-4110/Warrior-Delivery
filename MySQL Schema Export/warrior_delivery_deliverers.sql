...
--
-- Host: 127.0.0.1    Database: warrior_delivery
-- ------------------------------------------------------
...
CREATE TABLE `deliverers` (
  ...
  KEY `deliverer_order` (`current_order`),
  KEY `account_id_idx` (`account_id`),
  CONSTRAINT `account_id` FOREIGN KEY (`account_id`) REFERENCES `users` (`id`),
  CONSTRAINT `deliverer_order` FOREIGN KEY (`current_order`) REFERENCES `students` (`order_id`)
...
-- Dump completed on 2020-11-05  3:00:25
